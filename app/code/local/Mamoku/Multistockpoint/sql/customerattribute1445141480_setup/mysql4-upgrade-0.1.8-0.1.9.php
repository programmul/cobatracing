...
/*tambah no telephone & fax*/

$installer->addAttribute("customer", "no_telp",  array(
    "type"     => "varchar",
    "backend"  => "",
    "label"    => "no_telp",
    "input"    => "text",
...
$attribute   = Mage::getSingleton("eav/config")->getAttribute("customer", "no_telp");
$used_in_forms = array();
$used_in_forms[]="adminhtml_customer";
$used_in_forms[]="adminhtml_checkout";
$used_in_forms[]="customer_account_create";
